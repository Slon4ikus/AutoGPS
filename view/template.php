...
<head>
    ...
    <!--[if lt IE 9]> <link rel="stylesheet" type="text/css" href="<?php echo core_route::$path; ?>/css/IE.css" > <![endif]-->
    <!--[if IE 7]> <link rel="stylesheet" type="text/css" href="<?php echo core_route::$path; ?>/css/IE7.css" > <![endif]-->
    ...
    <div class="headerContainer2">
        <div class="headerContent">
            ...
            <div id="headerSlider">
                ...
                <a class="hidden sliderImage" href="<?php echo core_route::$path;?>/brands/otherList"
                   title="возможности">
